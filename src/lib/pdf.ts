...
export function generateInvoicePDF(order: Order, settings: Settings): jsPDF {
  ...
  doc.text(`© ${year} All rights reserved. ${settings.shopName}.`, 40, H - 20);
  doc.text("V2.1.0 · PREMIUM POS", W / 2, H - 20, { align: "center" });
  doc.text(`Powered by Cenexa Systems © ${year}`, W - 40, H - 20, { align: "right" });
